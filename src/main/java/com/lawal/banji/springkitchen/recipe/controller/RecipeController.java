...
//
//    @Autowired
//    public RecipeController(OrchestrationService orchestrationService) {
...
//        model.addAttribute("recipes", orchestrationService.findAllRecipes());
...
//        model.addAttribute("recipes", orchestrationService.searchRecipes(string));
//        model.addAttribute("view", RECIPE_LIST_VIEW);
...
//        }
//        orchestrationService.saveRecipe(recipe);
...
//        Recipe recipe = orchestrationService.findRecipeById(id);
...
//        model.addAttribute("stepList", recipe.getSteps());
//        model.addAttribute("stepCount", recipe.getSteps().size());
//        model.addAttribute("recipe", recipe);
//        model.addAttribute("view", RECIPE_FORM_VIEW);
