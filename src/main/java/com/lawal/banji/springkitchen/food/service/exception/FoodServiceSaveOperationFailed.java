...
public class FoodServiceSaveOperationFailed extends RuntimeException {

    private static final long serialVersionUID = 1L;
    public static final String MESSAGE = "Food not saved by FoodService";
    public static final String MESSAGE_TEMPLATE = "Food '%s' source not saved by FoodService";

    public FoodServiceSaveOperationFailed() {
        super(MESSAGE);
    }
