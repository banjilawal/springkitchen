...
//
//    @Autowired
//    public FoodController(OrchestrationService orchestrationService) {
...
//        model.addAttribute("foods", orchestrationService.findAllFoods());
...
//        model.addAttribute("foods", orchestrationService.searchFoods(string));
//        model.addAttribute("view", FOOD_LIST_VIEW);
...
//        try {
//            Food food = orchestrationService.findFoodById(id);
...
//        Food food = (id == null) ? orchestrationService.generateFood() : orchestrationService.findFoodById(id);
...
//                );
//                savedFood = orchestrationService.saveFood(food);
//
//                if (savedFood == null) {
//                    AppLogger.error(
//                        FoodController.class,
...
//                );
//                savedFood = orchestrationService.updateFood(id, food);
//
//                if (savedFood == null) {
//                    AppLogger.error(
//                        FoodController.class,
...
//        orchestrationService.deleteFood(id);
//
//        model.addAttribute("foods", orchestrationService.findAllFoods());
//        model.addAttribute("view", FOOD_LIST_VIEW);
